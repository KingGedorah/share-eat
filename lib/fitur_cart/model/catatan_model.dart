...
List<CatatanUser> cartPageFromJson(String str) => List<CatatanUser>.from(
    json.decode(str).map((x) => CatatanUser.fromJson(x)));

String cartPageToJson(List<CatatanUser> data) =>
